        ...
        <div className="container mt-5 p-5 shadow back">
            <div className="row">
                ...
                <div className='col-lg-4'>
                    ...
                    <button className='savebutton m-1'
                        // onClick={() => {
            ...
            <div className="row">
                <div className="col-lg-3">
                    <div id="navbar" className="sidenav d-flex flex-column overflow-scroll mt-3">
                        <nav className="navbar navbar-light">
                        </nav>
                        <div className='my-2 d-flex flex-column'>
                            <button type='button' className='btn btn-outline-secondary btn-sm mx-2  text-white'
                                onClick={() => {
                                    increasePage();
                            ...
                            <button type='button' className='btn btn-outline-secondary btn-sm mx-2  text-white'
                                onClick={() => {
                                    ...
                                    let selectedIdx = arrayOfPages.findIndex((page) => page.cid === selectedPage.cid);
                                    console.log(selectedIdx)
                                    console.log(selectedPage);
                                    console.log(arrayOfPages);
                                    if (selectedIdx + 1 < arrayOfPages.length) {
                                        pageManager.select(pageManager.get(arrayOfPages[selectedIdx + 1]["id"]));
                                    }
                                }}>Next</button>
                        </div>
                        <div>
                ...
                <div className="col-lg-3 RightSide_NavBar">
                    <ul className='list-group-pages text-white'>
                    </ul>
                </div>
            </div >
        </div >
