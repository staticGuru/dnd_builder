  ...
  return (
    <div className="bg-blue-600 flex flex-1 flex-col d-flex h-full p-2">
      <div className="bg-blue-600 flex flex-1 flex-col d-flex">
        <span className="text-base text-black font-bold m-2">Option</span>
        ...
        />
        <span className="text-base text-black font-bold m-2">OptionKey</span>
        <input
          ...
          style={{marginLeft:"1rem",marginRight:"1rem"}}
        />
        <div className="flex flex-row d-flex" style={{width:"max-content",justifyContent:"center",alignItems:"center"}}>
          <label
            class="inline-block hover:cursor-pointer text-base text-black font-bold m-2"
